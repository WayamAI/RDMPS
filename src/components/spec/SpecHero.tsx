...
const HEADLINE = 'Every design choice traces to a clause.';

const CHIPS = [
  { icon: FileText, label: '215 pp spec' },
  { icon: Layers, label: '7 annexures' },
  { icon: Landmark, label: '6 standards bodies' },
];
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1200px] px-4 pb-16 pt-20 sm:px-6 md:pb-24 md:pt-28">
        <motion.p
          ...
          className="font-mono text-[11px] font-medium uppercase tracking-[0.14em] text-flow-poc"
        >
        ...
        >
          The RDPMS POC LLD is built clause-by-clause from the RDSO specification. This page is the
          traceability index  the map from requirement to architecture.
        </motion.p>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          {CHIPS.map((chip, i) => (
            ...
            >
              <chip.icon className="h-3.5 w-3.5 text-flow-poc" strokeWidth={2} />
              {chip.label}
            </motion.span>
          ))}
        </div>
